...
.pr { font-family: var(--font-body); background: var(--c-bg); color: var(--c-white); overflow-x: hidden; min-height: 100vh; width: 100%; margin: 0; padding: 0; }
  ...
  .contact-cta { font-size:clamp(2rem,10vw,8rem); font-family:var(--font-head); font-weight:900; letter-spacing:-.04em; line-height:.9; color:#ffffff; text-decoration:none; display:block; transition:all .6s; width:100%; overflow:hidden; }
